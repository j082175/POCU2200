...
int main(void)
{
    const char* file1 = "Superman_v1.txt";
    const char* file2 = "Batman_v2.txt";
    const char* file3 = "Flash_v3.txt";
    const char* file4 = "Wonderwoman_v3.txt";
    character_v3_t out1 = { 0, };
    character_v3_t out2 = { 0, };
    character_v3_t out3 = { 0, };
    character_v3_t out4 = { 0, };
    test();


    get_character(file1, &out1);
    get_character(file2, &out2);
    get_character(file3, &out3);
    get_character(file4, &out4); 
